...
<header class="front-hero" role="banner">
	<div class="marketing">
		<div class="tagline">
			...
			<a role="button" class="download large button sites-button hide-for-small-only" href="https://github.com/olefredrik/foundryforged">Download foundryforged</a>
		</div>

		<div class="watch">
			<span id="stargazers"><a href="https://github.com/olefredrik/foundryforged">1.5k stargazers</a></span>
...
<?php do_action( 'foundryforged_before_content' ); ?>
<?php while ( have_posts() ) : the_post(); ?>
<section class="intro" role="main">
	<div class="fp-intro">

		<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
			<?php do_action( 'foundryforged_page_before_entry_content' ); ?>
			...
			<footer>
				<?php
					wp_link_pages(
						array(
							'before' => '<nav id="page-nav"><p>' . __( 'Pages:', 'foundryforged' ),
							'after'  => '</p></nav>',
						)
					);
				?>
			...
			<?php do_action( 'foundryforged_page_before_comments' ); ?>
			<?php comments_template(); ?>
			<?php do_action( 'foundryforged_page_after_comments' ); ?>
		</div>
...
<?php endwhile; ?>
<?php do_action( 'foundryforged_after_content' ); ?>
